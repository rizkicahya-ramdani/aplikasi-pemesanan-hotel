              ...
              <?php echo form_open_multipart('tipekamar/update') ?>
                <div class="card-body">                
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" value="<?php echo $value->id_kamar_tipe; ?>" disabled>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="nama_kamar_tipe" value="<?php echo $value->nama_kamar_tipe; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Fasilitas</label>
                        <div class="col-sm-8">
                            <textarea name="fasilitas" class="form-control" value="<?php echo $value->fasilitas; ?>"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="harga" value="<?php echo $value->harga; ?>" placeholder="Keterangan" required>
                        </div>
                    </div> 
                </div>
