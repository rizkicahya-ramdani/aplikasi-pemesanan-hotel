              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url('kamar/update') ?>">
                <div class="card-body">                
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="id_kamar_tipe" value="<?php echo $value->id_kamar_tipe; ?>" placeholder="ID Kamar Tipe" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Nomor Kamar</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="nomor_kamar" value="<?php echo $value->nomor_kamar; ?>" placeholder="Nomor Kamar" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Max Dewasa</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="max_dewasa" value="<?php echo $value->max_dewasa; ?>" placeholder="Max Dewasa" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Max Anak</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="max_anak" value="<?php echo $value->max_anak; ?>" placeholder="Max Anak" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <select class="form-control" style="width: 100%;" name="status_kamar" required>
                            <option value="<?php echo $value->status_kamar ?>" selected></option>
